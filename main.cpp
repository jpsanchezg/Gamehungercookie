...
int gameover  ( int numeros[maxf][maxc], int nfilas, int ncol,int pojf,int pojc,int alienf,int alienc,int abisf, int abisc);
    ...
    do
    {
        ...
        if (opcion == 'a')
        {
            ...
            if (contad == 1)
            {
                ...
                cout<<olor<<endl;
                contad=0;
                muertos = gameover (numeros,nfilas,ncol,pojf,pojc,alienf,alienc,abisf,abisc);
                if (muertos == 8)
                {
                    muerto = true;
                }
